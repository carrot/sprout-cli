...
var ListCommand = require('./../lib/commands/list')
    ...
    describe('add',
      function () {
        ...
        it('should add a local template',
          function (done) {
            var cli = new CLI(process.cwd())
            var fixture = path.join(commandsAddFixturesPath, 'local')
    ...
    describe('init',
      function () {
        ...
        it('should init a template',
          function (done) {
            var cli = new CLI(process.cwd())
            var fixture = path.join(commandsInitFixturesPath, 'init')
        ...
        it('should parse locals passed to init',
          function (done) {
            var cli = new CLI(process.cwd())
            var fixture = path.join(commandsInitFixturesPath, 'locals')
            var src = path.join(fixture, 'src')
            var target = path.join(fixture, 'target')
            return gitInit(src).then(
              function () {
        ...
        it('should send config file to init',
          function (done) {
            var cli = new CLI(process.cwd())
            var fixture = path.join(commandsInitFixturesPath, 'config')
            var src = path.join(fixture, 'src')
            var target = path.join(fixture, 'target')
            return gitInit(src).then(
              function () {
